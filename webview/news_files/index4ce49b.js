...
function R(e){
try{
for(var c=window.pageYOffset||document.documentElement.scrollTop,l=0;l<V.length;l+=L){
var g=V[l];
if(!(g.offsetTop>c+x.getInnerHeight()+100)){
var u=w.attr(g,"data-cpsstatus");
if("hide"==u){
g.setAttribute("data-cpsstatus","loading");
for(var f=""+l,y=1,v=l+1;v<V.length&&l+L>v;v++)f=f+"%2c"+v,y++;
...
window.__wxjs_is_wkwebview&&B.setSum(28307,67,1);
}
try{
...
key:26,
value:1
}),T.init(),y.invoke("createWebViewForFastLoad",{
scene:1
},function(e){
console.log(e);
}));
...
if(!o){
if(!a&&u)return;
if(!_.isWechat&&!a)return void window.weui.alert("Make the payment in WeChat.");
u=!0;
}
var i=t.currentTarget;
if(!a&&1*i.dataset.ready===0)return!o&&z.show("Generating order..."),setTimeout(v,100,{
currentTarget:i
},!0);
...
e("appmsg/popup_report.js")),E=e("appmsg/pay_report_utils.js"),z=e("appmsg/loading.js"),P=-1,S=e("appmsg/finance_communicate.js"),T=e("appmsg/topbar.js"),B=e("biz_wap/utils/jsmonitor_report.js"),C=e("appmsg/getForbidConfig.js");
window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var R=window.user_uin||0,O=Math.floor(R/100)%1e3,q=0!==R&&1001>O,N=!0,D="",L=5;
