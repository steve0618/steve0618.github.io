...
var p=i?(a+1)/(i+1)*paragraphList.length:paragraphList.length/2,_=n?e.position_index:Math.floor(p)-1;
_=0>_?0:_;
var r=paragraphList[_],d=r.parentNode,s=document.createElement("p");
d.appendChild(s);
var l=s.offsetWidth;
if(d.removeChild(s),l<.7*contentWrp.offsetWidth)return void commonUtils.report120081(void 0!==e.position_index?23:15);
...
for(var p in e){
var _=e[p],r=_.pos_type===AD_POS.POS_MID,d=_.pos_type===AD_POS.POS_AD_BEFORE_VIDEO,s=_.pos_type===AD_POS.POS_BOTTOM;
s=s&&CrtManager.CRT_CONF[_.crt_size],s=s||n.indexOf(_.crt_size)>-1,r&&t++,s&&a++,
r||d&&0===_.is_mp_video||s||_.pos_type===AD_POS.POS_AD_AFTER_VIDEO||d&&1===_.is_mp_video||_.pos_type===AD_POS.POS_SPONSOR&&"1"===utils.getExpParaVal(_,"widget_gray_free_trade")?o.push(_):i.push(_);
}
if(a>1){
for(var l=[],c={
aid:Date.now(),
pos_type:AD_POS.POS_BOTTOM
},p=o.length-1;p>=0;p--)o[p].pos_type===AD_POS.POS_BOTTOM&&l.push(o.splice(p,1)[0]);
...
var a=t.app_info.app_size||0,i=t.app_info.app_name||t.app_info.appname||"",o=t.app_info.apk_url||t.app_info.pkgurl||"",n=t.app_info.file_md5||t.app_info.pkgmd5||t.app_info.app_md5||"",p=t.app_info.apk_name||t.app_info.pkg_name||"";
a=utils.formSize(a),i=utils.formName(i),t.app_info.app_size=a,t.app_info.app_name=i,
t.app_info.apk_name=p,t.app_info.appname=t.app_info.app_name,t.app_info.app_rating=t.app_info.app_rating||0,
...
var i=a.app_info.app_size||0,o=a.app_info.app_name||a.app_info.appname||"",n=a.app_info.apk_url||a.app_info.pkgurl||"",p=a.app_info.file_md5||a.app_info.pkgmd5||a.app_info.app_md5||"",_=a.app_info.apk_name||a.app_info.pkg_name||"",r=a.app_info.category,d=["0K","M","00M"],s=a.app_info.down_count||0;
if(s>=1e4){
s/=1e4;
for(var l=0;s>=10&&2>l;)s/=100,l++;
s=s.toFixed(1)+d[l]+" times";
}else s=s.toFixed(1)+" times";
return r=r?r[0]||"Other":"Other",i=utils.formSize(i),o=utils.formName(o),a.app_info._down_count=s,
a.app_info._category=r,a.app_info.app_size=i,a.app_info.app_name=o,a.app_info.apk_name=_,
...
a.app_info.type=a.type,a.app_info.adid=a.aid,a.app_info.file_md5=p,t=utils.extend({
...
var o={},n={},p=e.is_need_ad,_=e._adInfo;
if(0==p)n=_,n||(n={
advertisement_num:0
});else{
...
var C=P.app_info.down_count||0,j=P.app_info.app_size||0,k=P.app_info.app_name||"",N=P.app_info.category,M=["0K","M","00M"];
if(C>=1e4){
C/=1e4;
for(var Y=0;C>=10&&2>Y;)C/=100,Y++;
C=C.toFixed(1)+M[Y]+" times";
}else C=C.toFixed(1)+" times";
j=utils.formSize(j),N=N?N[0]||"Other":"Other",k=utils.formName(k),P.app_info._down_count=C,
...
if(0==P.pos_type){
if(P.new_appmsg=window.new_appmsg,P.longAppBtnText=T===AD_TYPE.IOS_APP_PRODUCT_TYPE?"View App":"Download App",
P.shortAppBtnText=T===AD_TYPE.IOS_APP_PRODUCT_TYPE?"View":"Download",js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,P),
...
mmversion.isIOS&&P.app_info&&P.app_info.url_scheme&&T===AD_TYPE.IOS_APP_PRODUCT_TYPE&&(document.getElementById("js_promotion_tag")&&(document.getElementById("js_promotion_tag").innerHTML="View App"),
document.getElementsByClassName("js_ad_btn")&&document.getElementsByClassName("js_ad_btn").length>0&&(document.getElementsByClassName("js_ad_btn")[0].innerHTML="View"),
document.getElementById("js_ad_btn_"+P.pos_type)&&(document.getElementById("js_ad_btn_"+P.pos_type).innerHTML="View App"));
}else{
var et,tt={},Q=!1,at={};
if(P.button_action)try{
"string"==typeof P.button_action&&(P.button_action=JSON.parse(P.button_action.html())),
P.button_action.button_text&&""!=P.button_action.button_text||(P.button_action.button_text="Explore");
}catch(z){
P.button_action={
...
i.indexOf("get_install_state:yes")>-1&&P.app_info.url_scheme&&(o.textContent=354==parseInt(t.crt_size)||117==parseInt(t.crt_size)||355==parseInt(t.crt_size)||568==parseInt(t.crt_size)?"Enter":"Open App");
});
...
P.report_param=ot;
var pt=ad_render_object["pos_"+P.pos_type].getWrapperElm().getElementsByClassName("js_video_container_new_protocol");
pt[0]&&(pt=pt[0],P.videoContainer=pt,videoAdMap[P.aid]=new VideoAd(P));
}
...
if(is_temp_url&&adElCountMapByPos[AD_POS.POS_MID]&&!c)for(var _t=0;_t<adElCountMapByPos[AD_POS.POS_MID];_t++){
if(!utils.checkShowCpc(el_gdt_areas[utils.getPosKeyDesc(AD_POS.POS_MID,_t)],globalAdDebug,contentWrp))return;
el_gdt_areas[utils.getPosKeyDesc(AD_POS.POS_MID,_t)].innerHTML=TMPL.tmpl(cpc_a_tpl,{
type:"",
ticket:"",
url:"",
rl:"",
...
if(5==e.watermark_type&&(a.btn_text="View Details"),29===t||31===t?a.btn_text="View Details":t===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||t===AD_TYPE.IOS_APP_PRODUCT_TYPE?a.btn_text=t===AD_TYPE.IOS_APP_PRODUCT_TYPE?"View App":"Download App":30===t?a.btn_text="Explore":t===AD_TYPE.ADD_CONTACT_PRODUCT_TYPE?a.btn_text=e.biz_info.is_subscribed?"View Official Account":"Follow Official Account":t===AD_TYPE.MINI_GAME_PRODUCT_TYPE&&(a.btn_text="Enter Mini Game"),
e.dest_type===AD_CONFIG.AD_DEST_TYPE.CANVAS_AD_DEST_TYPE&&(a.btn_text="View Details"),
e.cpc_exp_info&&e.cpc_exp_info.exp_content){
var i=e.cpc_exp_info.exp_content;
try{
for(var o=JSON.parse(i.replace(/&quot;/g,'"')),n=-1,p=0;p<o.aid_list.length;p++)o.aid_list[p].aid==e.aid&&(n=p);
...
function ad_click(e,t,a,i,o,n,p,_,r,d,s,l,c,m,u,f,g,A,y){
if(!has_click[o]){
has_click[o]=!0;
{
...
var a=handleApp(t,o,idx,mid,biz,r,_,s,d,l,g,n,A);
if(a)return;
}
...
if(y)if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.OUTER_DEST_TYPE)handleH5(t,o,idx,mid,biz,r,_,s,d,l,g);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.WECHAT_APPLET_DEST_TYPE)Wxopen_card.openWxopen(l);else if(g.dest_type===AD_CONFIG.AD_DEST_TYPE.AD_DEST_TYPE)openUrlWithExtraWebview(t);else{
...
if(i){
var o,n,p=i.adData,_=i.a_info,r=_.pos_type,d=_.pos_type,s=i.ad_engine,l=t.getElementsByClassName("js_ad_opt_list_btn_"+r),c=t.getElementsByClassName("js_complain_btn_"+r);
if(2==_.use_new_protocol){
...
if(m.length>0&&(n=p.tid||_.traceid,o=_.aid,DomEvent.on(m[0],"click",function(e){
var t=_,a=!!e&&e.target;
if(_&&_.has_installed&&("104"==p.pt||"113"==p.pt||"114"==p.pt||"2"==p.pt)?utils.report(114,f):"103"==p.pt||"111"==p.pt||"112"==p.pt?utils.report(23,f):("104"==p.pt||"113"==p.pt||"114"==p.pt)&&utils.report(25,f),
...
var i,r,l=t.type,c=t.url,u=t.rl,g=t.apurl,A=t.ticket,y=t.group_id,D=t.pt,v=_.use_new_protocol;
...
ad_click(l,c,u,g,n,A,y,o,D,d,s,p,w,T,i,r,_,f,v),log("[Ad] ad_click: type="+l+", url="+c+", rl="+u+", apurl="+g+", traceid="+n+", ticket="+A+", group_id="+y+", aid="+o+", pt="+D+", pos_type="+d+", ad_engine="+s);
}
})),u.length>0&&_.button_action&&3!=_.pos_type)if(_.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||_.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE){
var g=require("a/app_card.js"),A=15,y=p.pkgname&&p.pkgname.replace(/\./g,"_");
new g({
btn:u[0],
adData:p,
report_param:f,
...
via:[p.traceid,p.adid,y,source,A,s].join("."),
ticket:p.ticket,
appdetail_params:["&aid="+p.adid,"traceid="+p.traceid,"pkgname="+y,"source="+source,"type="+A,"engine="+s,"appuin="+biz,"pos_type="+d,"ticket="+p.ticket,"scene="+scene].join("&"),
engine:s,
percentStatus:function(t,a){
var i=ad_render_object[e].getData();
i.percent=a,"downloading"==t?i.btn_text="Pause":"paused"==t?i.btn_text="Continue":"installed"==t?(i.percent=0,
i.btn_text="Installed"):"downloaded"==t?(i.percent=0,i.btn_text="Install"):"gotodetail"==t?(i.percent=0,
i.btn_text=117==parseInt(_.crt_size)||354==parseInt(_.crt_size)||355==parseInt(_.crt_size)||568==parseInt(_.crt_size)?"Enter":"Open App"):(i.percent=0,
i.btn_text=117==parseInt(_.crt_size)||354==parseInt(_.crt_size)||355==parseInt(_.crt_size)||568==parseInt(_.crt_size)?"Enter":"Open App"),
ad_render_object[e].updateData(i);
}
});
}else if(_.product_type==AD_TYPE.ADD_CONTACT_PRODUCT_TYPE){
var D=require("a/profile.js");
p.adid=window.adid||p.adid||p.aid,new D({
btnProfile:u[0],
adData:p,
pos_type:d,
report_param:f,
...
}else _.product_type==AD_TYPE.CARD_PRODUCT_TYPE?new Card({
btn:u[0],
adData:p,
report_param:f,
pos_type:d
}):_.product_type==AD_TYPE.WECHATCARD_PRODUCT_TYPE?new MpShop({
btn:u[0],
adData:p,
report_param:f,
pos_type:d
}):DomEvent.on(u[0],"click",function(e){
var t=p,a=!!e&&e.target,i=t.type,o=_.button_action.jump_url,n=t.rl,l=t.apurl,c=t.tid||_.traceid,m=t.ticket,f=t.group_id,g=t.aid,A=t.pt,y=_.use_new_protocol;
if(console.info("[广告新协议点击素材]",_.dest_type,_.product_type),p){
p.adid=window.adid||p.adid||p.aid;
var D="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+s+"&pos_type="+d+"&r="+Math.random();
}
var v,P,h,w;
...
return ad_click(i,o,n,l,c,m,f,g,A,d,s,p,O,b,h,w,_,D,y),log("[Ad] ad_click: type="+i+", url="+o+", rl="+n+", apurl="+l+", traceid="+c+", ticket="+m+", group_id="+f+", aid="+g+", pt="+A+", pos_type="+d+", ad_engine="+s),
hideComplainBtns(),!1;
});
}else for(var v=0,P=a.length;P>v;++v)!function(e,t){
var i=a[e],p=i.dataset;
if(p&&3!=_.pos_type){
var r=p.type,l=p.url,c=p.rl,m=p.apurl,u=p.ticket,f=p.group_id,g=p.pt,A=_.use_new_protocol,y=!0;
n=p.tid,o=p.aid,(A&&(_.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||_.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE)||115===g)&&(y=!1),
_.pos_type===AD_POS.POS_MID&&(y=!1),DomEvent.on(i,"click",function(e){
...
var p="&tid="+t.traceid+"&uin="+uin+"&key="+key+"&ticket="+(t.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+t.adid+"&ad_engine="+s+"&pos_type="+d+"&r="+Math.random();
_&&_.has_installed&&("104"==t.pt||"113"==t.pt||"114"==t.pt||"2"==t.pt)?utils.report(114,p):"103"==t.pt||"111"==t.pt||"112"==t.pt?utils.report(23,p):("104"==t.pt||"113"==t.pt||"114"==t.pt)&&utils.report(25,p);
}
var y,D,v,P;
...
ad_click(r,l,c,m,n,u,f,o,g,d,s,t,y,D,v,P,_,p,A),log("[Ad] ad_click: type="+r+", url="+l+", rl="+c+", apurl="+m+", traceid="+n+", ticket="+u+", group_id="+f+", aid="+o+", pt="+g+", pos_type="+d+", ad_engine="+s),
!1;
}
...
var e=l[0].getElementsByClassName("js_ad_opt_list_"+_.pos_type);
utils.adOptReport(0,_.pos_type,n,o),e&&e[0]&&(e[0].style.display="none"==e[0].style.display?"block":"none");
}
return!1;
}),c[0]&&DomEvent.on(c[0],"click",function(){
var e="https://mp.weixin.qq.com/promotion/res/htmledition/mobile/html/feedback.html?aid="+o+"&traceid="+n+"&source="+_.pos_type+"&biz="+window.biz+"&material_id="+JSON.stringify(_.material_id_list);
return utils.adOptReport(1,_.pos_type,n,o),mmversion.isWp||mmversion.isIOS||mmversion.isAndroid?JSAPI.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(t){
-1==t.err_msg.indexOf("ok")&&(location.href=e);
}):openUrlWithExtraWebview(e),hideComplainBtns(),!1;
}),p&&2!=_.use_new_protocol){
p.adid=window.adid||p.adid||p.aid;
var h=_.exp_info||{},w=h.exp_id||"",T=h.exp_value||[];
try{
T=JSON.stringify(T);
}catch(E){
T="[]";
}
var f="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+s+"&pos_type="+d+"&exp_id="+w+"&exp_value="+T+"&r="+Math.random();
if(p.report_param=f,p.use_new_protocol){
if(_.product_type===AD_TYPE.ANDROID_APP_PRODUCT_TYPE||_.product_type===AD_TYPE.IOS_APP_PRODUCT_TYPE){
var g=require("a/app_card.js"),A=15,y=p.pkgname&&p.pkgname.replace(/\./g,"_"),O=document.getElementById("js_ad_btn_"+d);
new g({
btn:O,
adData:p,
report_param:f,
...
9==_.material_type&&(_.report_param=f,videoAdMap[_.aid]=new VideoAd(_));
}else{
...
if("102"==p.pt){
var b=require("a/android.js"),A=15,y=p.pkgname&&p.pkgname.replace(/\./g,"_");
return void new b({
btn:document.getElementById("js_app_action_"+d),
adData:p,
report_param:f,
task_ext_info:[p.adid,p.traceid,y,source,A,s].join("."),
via:[p.traceid,p.adid,y,source,A,s].join(".")
});
}
if("101"==p.pt){
...
"118"==_.pt&&(p.report_param=f),"125"==_.pt&&(_.report_param=f,videoAdMap[_.aid]=new VideoAd(_));
}
}
}
}(e);
...
function launchIosAppBackup(e,t,a,i,o,n,p,_,r,d,s,l,c){
...
outer_id:d.outer_id
})):void utils.openWebAppStore(s.app_info.appinfo_url,l):void handleH5(e,t,a,i,o,n,p,_,r,d,s);
}
function handleApp(e,t,a,i,o,n,p,_,r,d,s,l,c){
...
function handleH5(e,t,a,i,o,n,p,_,r,d,s){
...
var n=this.aInfoMap[e.aid],p=document.createElement("div");
p.className="mpad_relative";
var _=o.nextSibling;
commonUtils.insertAfter(p,o),p.appendChild(o);
var r=createAdFrame(p,e);
...
},0),_&&p.appendChild(_),void(0===e.is_mp_video?utils.report115849(1):commonUtils.report120081(3));
}
}
...
return n?void(o=!1):(p++,r>=i-p&&_.createAdWebview(),void e());
},1e3);
}
function t(){
...
t.vid===window.cgiData.vid&&(p=parseInt(t.currentTime,10)>=parseInt(t.duration,10)?0:t.currentTime,
i=t.duration,"play"===t.state&&!o&&e());
});
}
var a=this,i=void 0,o=void 0,n=!1,p=0,_=this,r=10;
...
brandName:t&&""===window.nickname&&""===window.nickname_new?"Unnamed Official Account":window.title,
