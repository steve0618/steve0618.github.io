...
n.x5=s?"1":"0",n.f="json",a.join(e,n);
}
function t(e,n){
if(e instanceof Object&&n instanceof Object)for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(e[t]=n[t]);
}
function o(e){
"function"==typeof e?c.push(e):data instanceof Object&&f.push(e);
}
function i(e,n){
l[e]||(l[e]=[]),l[e].push(n);
}
var r=e("biz_wap/jsapi/core.js"),a=e("biz_common/utils/url/parse.js"),p=e("biz_wap/utils/log.js"),s=-1!=navigator.userAgent.indexOf("TBS/");
...
var r=l[o][i];
"function"==typeof r?t(e[o],r()):a instanceof Object&&t(e[o],r);
}
}
p("[leaveReport getDataFunc.length "+c.length+"]"),console.log("[leaveReport getDataFunc.length "+c.length+"]");
for(var i=0;i<c.length;i++){
var a=c[i]();
a instanceof Object&&f.push(a);
}
for(var i=0;i<f.length;i++)f[i].reportUrl&&(f[i].reportUrl=n(f[i].reportUrl));
return e.data={
requestList:f
},e;
});
...
return window.__leaveReport=u,u;
...
function c(e){
var t="";
if(parseInt(e,10)>1e5)t="100k+";else if(parseInt(e,10)>1e4&&parseInt(e,10)<=1e5){
var n=""+parseInt(e,10)/1e4,o=n.indexOf(".");
t=-1===o?n+"0K":n.substr(0,o)+"."+n.charAt(o+1)+"0K";
