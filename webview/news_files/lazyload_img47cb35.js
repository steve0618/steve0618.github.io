...
var l,u,h=!j.canJumpOnTap||j.isNonWechat,E=document.getElementById("js_pc_weapp_code"),B=document.getElementById("js_weapp_without_auth_dialog_mask"),R=document.getElementById("js_pc_weapp_code_img"),x=document.getElementById("js_pc_weapp_code_des");
...
var I=T[s].appid,A=T[s].path,N=T[s].imageUrl,q=T[s].title,L=T[s].elem,W=K[I];
...
if(z.resp&&z.resp.weapp_info&&z.resp.weapp_info.length)for(var H=0;H<z.resp.weapp_info.length;H++){
var O=L.getElementsByClassName("guarantee_icon")[0];
if(z.resp.weapp_info[H].weapp_appid===I&&1===z.resp.weapp_info[H].has_guarantee_flag){
O&&b.addClass(O,"show");
break;
}
}
...
beforeNonWechatWarn:function(){
d(I,s,W.nickname,q,e);
},
beforeJumpBackupPage:function(){
r(I,s,W.nickname,q,e);
},
...
}),window.__addIdKeyReport&&window.__addIdKeyReport("28307",100),n(I,s,W.nickname,q,3,e,P?2:0),
P&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",115),!1;
},k.isInMiniProgram&&-1===S.indexOf(I)&&k.gtVersion("7.0.5",!0)){
...
passive:!1
}),document.getElementById("js_weapp_without_auth_weappurl").src="",j.getAppidCode({
appid:I,
path:A
},function(e){
...
if(P&&C.report([2,1,"",img_popup?1:0,window.source,I]),(P||b.hasClass(L,"weapp_text_link")&&(o(L)||i(L)))&&img_popup){
...
return p.style.display="block",document.querySelector("body").addEventListener("touchmove",e,{
passive:!1
}),p._appid=I,p._i=s,p._nickname=W.nickname,p._title=q,n(I,s,W.nickname,q,3,1,0),
...
if(e){
var n=c(L),o=_(P?L.firstElementChild:L),i=c(L.parentNode),p=L.parentNode.offsetWidth,a=L.getBoundingClientRect().top,r=P?L.firstElementChild.offsetWidth:L.offsetWidth,d=P?L.firstElementChild.offsetHeight:L.offsetHeight,m=8,l=!1;
x.innerText=f(W.nickname,48),R.onload=t,R.src=e,(R.complete||R.width)&&t();
}
}
clearTimeout(l),u!==s&&(E.style.display="none",u=s,j.getAppidCode({
appid:I,
path:A
},e));
}),y.on(L,"mouseleave",function(){
p(E);
})),k.isInMiniProgram&&-1===S.indexOf(I)&&k.gtVersion("7.0.5",!0)&&y.on(B,"click",function(){
...
if(a.top<I.getInnerHeight()&&a.bottom>0){
setTimeout(function(){
...
n.voiceid=s.encodeStr(t),n.voiceid=n.voiceid.replace(/&#61;/g,"=").replace(/^\s/,"").replace(/\s$/,""),
...
i.nickname=window.nickname,s.renderPlayer(d,i,e);
var a=i.voiceid+"_"+i.posIndex,r=e.parentNode.querySelector('[data-preloadingid="'+a+'"]');
r&&r.parentNode.removeChild(r),t(i),p.musicList[i.voiceid+"_"+i.posIndex]=i;
}
function t(e){
...
e("biz_common/utils/string/html.js");
var d=e("pages/voice_tpl.html.js"),r=e("appmsg/log.js"),s=e("pages/voice_component.js"),p={
musicList:{},
musicLen:0,
...
r.preventDefault();
var _="";
d[j.getAttribute("data-itemshowtype")]&&(_=d[j.getAttribute("data-itemshowtype")]);
document.getElementById("js_link_dialog_name");
return y&&(c[E]&&c[E].subject_name&&"0"===c[E].item_show_type&&c[E].title?o(y,{
title:'即将打开公众号 "'+c[E].subject_name+'" 的'+d[c[E].item_show_type],
desc:w.innerText="《"+c[E].title+"》"
}):c[E]&&c[E].subject_name&&c[E].item_show_type>=0?o(y,{
desc:'即将打开公众号 "'+c[E].subject_name+'" 的'+d[c[E].item_show_type]
}):o(y,{
desc:"即将打开新的页面"
...
g=function(){
return c[E]&&c[E].item_show_type>=0&&s.indexOf("mp.weixin.qq.com")>-1&&(l.isIOS||l.isAndroid)&&!l.isInMiniProgram&&l.isWechat?1==j.getAttribute("clicked")?!1:(u.invoke("openWebViewUseFastLoad",{
url:s,
item_show_type:c[E].item_show_type,
openType:0,
scene:1
},function(e){
...
e("appmsg/popup_report.js")),p=e("biz_wap/utils/jsmonitor_report.js"),d={
0:"文章",
11:"文章",
8:"Image",
7:"Audio",
...
if("undefined"!=typeof jumpInfo)for(var _=0;_<jumpInfo.length;_++)c[jumpInfo[_].url]={
...
e.preventDefault(),window.weui.alert("Unable to do this in preview");
...
(new Image).src="https://badjs.weixinbridge.com/badjs?id=139&level=4&from="+window.encodeURIComponent(window.location.host)+"&msg="+window.encodeURIComponent(window.location.href),
