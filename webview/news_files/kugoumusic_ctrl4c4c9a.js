...
var t=e("pages/utils.js"),i=e("biz_wap/jsapi/core.js"),o=e("appmsg/log.js"),r=e("biz_wap/utils/mmversion.js"),a=e("biz_common/dom/event.js"),n={
classPrefix:window.qaClassPrefix,
previewFlag:!1
},s=function(e,t){
var i=new Date(1e3*e),o=e-t,r=i.getFullYear(),a=1*t,n=new Date(1e3*a);
i.setHours(0),i.setMinutes(0),i.setSeconds(0);
var s=i.getTime()/1e3;
return a>=s?3600>o?Math.ceil(o/60)+" minutes ago":"Today":a>=s-86400?"Yesterday":a>=s-172800?"2 days ago":n.getFullYear()===r?n.getMonth()+1+"Month"+n.getDate()+"Day":n.getFullYear()+"Year"+(n.getMonth()+1)+"Month"+n.getDate()+"Day";
},l=function(e,i,o){
if(i=i||Math.ceil((new Date).getTime()/1e3),1*o===1&&e.question){
var r=e.question;
e.biz_nickname=r.biz_nickname||"Anonymous",e.elected_comment_num=r.elected_comment_num||0,
e.like_num=r.like_num||0;
var a=r.question_info;
e.question_page_url=c(r.question_page_url.html(!1)),e.questioner_useruin=a.questioner_useruin,
e.qa_id=a.qa_id,a.question&&(a.question.ask_time_str=s(i,a.question.ask_timestamp),
e.questionTitle=a.question.title.html(!0).replace(/\r/g,"").replace(/\n/g,"<br>").replace(/\s/g,"&nbsp;"),
e.questionTitle=t.emojiFormat(a.question.title));
}else if(1*o===2&&e.topic){
var n=e.topic;
e.useful_num=n.useful_num||0,e.elected_comment_num=n.elected_comment_num||0,e.topicName=n.topic&&n.topic.wording||"暂无主题",
e.topicId=n.topic&&n.topic.id||1,e.biz_nickname=n.biz_nickname||"",e.biz_headimg=n.biz_headimg||"https://mmbiz.qpic.cn/mmbiz_png/cVgP5bCElFjtIK2EeF0OjuGhbZVFRYyGRfbFeZ9GibWsibibIWP7XRSKews1ibWFZD5biaSXb7HfMF6dMricUib4naAFw/0";
...
if(!n.previewFlag){
n.previewFlag=!0,"undefined"==typeof window.getComputedStyle&&(window.getComputedStyle=document.body.currentStyle?function(e){
...
if(a){
var l=window.getComputedStyle(a),u=document.createElement("canvas");
...
if(!r.isAndroid)try{
m.drawImage(a,0,0,parseFloat(l.width),parseFloat(l.height)),s=u.toDataURL();
}catch(c){
s="";
}
...
var t="."+n.classPrefix+"preview_js";
