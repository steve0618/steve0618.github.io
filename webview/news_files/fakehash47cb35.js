...
S.invoke("musicPlay",{
app_id:"a",
title:"WeChat Official Accounts Platform",
singer:"WeChat Official Accounts Platform",
epname:"WeChat Official Accounts Platform",
...
1*b._playtype>0){
var a={};
return a.err_code=1,void o(a);
}
var n=this,s=this._o,r=n._g;
...
var a=1*n._status;
!i||1!==a&&2!==a&&4!==a?(e("waiting"),r.stateChangeCallback.play=function(t,i){
0==t?e("play"):0!=t&&o({
err_code:2,
err_msg:i||""
});
...
var o=t.onError,i=t.onSuccess,a=t.needStartMusicUI;
"function"!=typeof o&&(o=function(){}),"function"!=typeof i&&(i=function(){}),1==b.surportType?a?o():this._jsapi_musicPlay({
onError:function(){
e._h5Play();
}
...
}):(a||e._h5Play(),e._trigger("jsapi2Begin2PlayErr")),"function"==typeof o&&(o(),
o=null,i=null);
}
});
...
!!b.debug&&console.log("setTimeout to play"),i.stateChangeCallback.play=null,a.seeking=!1,
a.curTime=n,o._resumeJsapiPlay(!0);
