...
console.log("reloadRewardData:",e),A=[],o({
...
E.rewardTotalText&&(E.rewardTotalText.innerText=" like(s)"),T.isWindowsWechat&&E.reward.classList.add("reward_area_win"),
e.can_whisper?N():q();
}
}
...
var H=[].concat(L),M=document.getElementById("js_reward_total");
if(z=16*p,A=[].concat(L),M)if(M.innerText=e.reward_total,T.isWindowsWechat){
var R=M.parentNode;
...
for(var a=(t-1)*z,i=s?3*p:0,d=document.createDocumentFragment(),c=a+i,l=t===r?e.reward_total:t*z;l>c;c++)w(d,n?window.defaultAvatarUrl:A[c]);
...
t=s>H&&0>=r?!1:H>s&&r+a>=i?!1:!0,t||e.preventDefault();
}
},O=function(){
...
return weui.alert(e&&e>T.whisperMaxLen?"悄悄话不可以超过字":"Network unavailable. Try again later.");
};
...
T.sendLock=!1,I.hide(),t&&t.base_resp&&0===t.base_resp.ret?(d(),q(),weui.toast("Posted",1e3)):s(e.length);
},
error:function(){
...
t[e]&&w.report115849(t[e]);
}
function a(e){
var a=e.adData,_=e.pos_type||0,b={},w=e.a_info;
...
if(!b[n]){
b[n]=!0;
var p,c,l,d,u=!!e&&e.target;
u&&(p=f.getX(u,"js_ad_link")+e.offsetX,c=f.getY(u,"js_ad_link")+e.offsetY,l=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var y=e.btnAddContact,v=e.btnViewProfile;
if(y&&y.dataset){
var z=function C(i,o){
var s=i.err_msg,r=a.is_appmsg?6:1;
-1!=s.indexOf("ok")?(v.style.display="inline-block",y.style.display="none",r=a.is_appmsg?9:4):"add_contact:added"==s?r=a.is_appmsg?7:2:"add_contact:cancel"==s?r=a.is_appmsg?8:3:(--o,
...
-1!=r.indexOf("ok")?(e.adData.biz_info.is_subscribed=1,console.log(s),s.innerHTML=s.innerHTML.replace("Follow","View"),
...
p(e,o,s);
}):(r="addContact:fail|msg:"+r+"|uin:"+uin+"|biz:"+biz,d("http://mp.weixin.qq.com/mp/jsreport?key=13&content="+r+"&r="+Math.random()),
...
var c=o.tid,l=o.type,p=o.url,d=o.rl;
if(!b[c]){
console.log("has_click[tid]",b[c]),b[c]=!0;
var j,g,w,y,v=!!t&&t.target;
v&&(j=f.getX(v,"js_ad_link")+t.offsetX,g=f.getY(v,"js_ad_link")+t.offsetY,w=document.getElementsByClassName("js_ad_link")[0]&&document.getElementsByClassName("js_ad_link")[0].clientWidth,
...
var o,s,r,p,c,l=e("biz_common/dom/event.js"),d=e("biz_common/utils/report.js"),_=e("a/a_report.js"),m=_.AdClickReport,u=(e("biz_wap/utils/ajax.js"),
...
window.__report,e("biz_wap/utils/jsmonitor_report.js")),w=e("a/a_utils.js");
return a;
