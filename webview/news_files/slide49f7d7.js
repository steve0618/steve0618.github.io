...
});define("new_video/player.js",["page/pages/video.css","biz_common/utils/string/html.js","biz_wap/zepto/zepto.js","biz_wap/zepto/event.js","biz_wap/zepto/touch.js","biz_wap/jsapi/log.js","biz_common/dom/event.js","new_video/player.html.js","biz_wap/utils/device.js","new_video/ctl.js","biz_common/tmpl.js","pages/iframe_communicate.js","a/a_utils.js","biz_common/utils/url/parse.js","pages/version4video.js","biz_wap/utils/wapsdk.js","biz_common/base64.js","biz_wap/jsapi/core.js","new_video/plugin/util.js","biz_wap/utils/jsmonitor_report.js","common/utils.js"],function(e){
"use strict";
function t(){
o(),i();
}
...
if((e&&e.autoplay||this.opt.autoplay||window.__auto_play__)&&m.device.inWechat)return window.__auto_play__=!1,
this.videoCtlReport({
step:15
...
t.showLoading("firstTime"),this.showControllBar(),t.opt.flowNotice&&t.__firstLoadedFlowNoticeJudge(),
setTimeout(function(){
try{
t.__continueSec&&(t.__replaySec=t.__continueSec,t.__continueSec=null),t._jsapiLog("set continue:"+t.__replaySec),
i.play();
}catch(e){
t._jsapiLog("play error");
}
},1);
},
...
var e=t("a/a_config.js"),p=t("biz_wap/utils/ajax.js"),n=t("a/a_sign.js"),_=t("biz_common/utils/url/parse.js");
return{
484:{
...
var p=i.getElementsByTagName("span")[0],n=i.getElementsByTagName("span")[1],_=t.biz_info.original_cnt>=10?t.biz_info.original_cnt+"篇原创文章":"",r=t.biz_info.comm_sub_cnt>0?t.biz_info.comm_sub_cnt+"位朋友关注":"";
_?(p.innerHTML=_,n.innerHTML=r):r?p.innerHTML=r:t.biz_info.signature?p.innerHTML=t.biz_info.signature:e();
},
error:function(){
e();
}
