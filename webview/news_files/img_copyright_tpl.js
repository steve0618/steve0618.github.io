...
function s(){
At.mylist.children.length?(m(At.mylist.parentNode),Qt||Y.removeClass(document.body,Xt)):(a(At.mylist.parentNode),
Qt||Y.addClass(document.body,Xt));
}
function d(e){
At.el_alertContent.innerHTML=e,At.el_alertPanel.style.display="";
}
function l(){
Qt?(Y.removeClass(document.getElementById("js_success_panel_pc"),"weui-transition_opacity-hide"),
setTimeout(function(){
Y.addClass(document.getElementById("js_success_panel_pc"),"weui-transition_opacity-hide");
...
if("undefined"!=typeof e)if(bt.idkey)ft.setSum(bt.idkey,e,1);else{
...
e.top<et.getInnerHeight()&&Pt&&t&&(ft.setLogs({
id:28307,
key:45,
value:1,
lc:1,
...
var o=t/1e3-e,i=n/1e3-e,m=new Date(n).getFullYear(),a=new Date(1e3*e);
return 3600>o?Math.ceil(o/60)+" minutes ago":86400>i?Math.floor(o/60/60)+" hours ago":172800>i?"Yesterday":604800>i?Math.floor(i/24/60/60)+" days ago":a.getFullYear()===m?a.getMonth()+1+"Month"+a.getDate()+"Day":a.getFullYear()+"Year"+(a.getMonth()+1)+"Month"+a.getDate()+"Day";
}
function w(e){
...
function y(e,t,n){
var o=void 0,i=void 0,m="",a="",s=document.createElement("div");
"elected"===n?a=0:"friend"===n&&(a=1),Ut={};
for(var d=0;d<e.length;d++){
if(i=e[d],i.time=f(i.create_time),i.status="",i.logo_url=i.logo_url||mn,i.logo_url=-1!==i.logo_url.indexOf("wx.qlogo.cn")?i.logo_url.replace(/\/132$/,"/96"):i.logo_url,
...
i.report_elected=i.is_elected||0,i.report_friend=i.is_from_friend||0,i.scene=a,i.reply.reply_list.length>0){
...
l.reply_like_num=l.reply_like_num||0,l.reply_like_num_format=parseInt(l.reply_like_num,10)>=1e4?(l.reply_like_num/1e4).toFixed(1)+"0K":l.reply_like_num,
"en"===window.LANG&&(l.reply_like_num_format=nt.dealLikeReadShow_en(l.reply_like_num));
}
i.new_appmsg=window.new_appmsg,m+=mt.tmpl(G,i);
try{
var c=i.nick_name+i.content,r=!1,p=bt.repeatContentID;
Ut[c]&&(r=!0,p=bt.repeatContent),Rt.indexOf(i.content_id)>-1&&(r=!0,p=bt.repeatContentID),
...
function h(e){
var t=void 0,n=void 0,o=Date.now(),i=e.resp,s=e.loadTime,d=e.forceRefresh,l=document.createDocumentFragment(),c=document.createDocumentFragment();
if(Et=i.only_fans_can_comment,_(bt.handleList,encodeURIComponent(JSON.stringify({
comment_id:xt,
offset:St,
url:Kt
}))),1!==i.enabled?($t&&($t.style.display="none"),en&&a(en),i.elected_comment=[],
i.friend_comment=[],i.elected_comment_total_cnt=0,i.friend_comment_total_cnt=0):($t&&($t.style.display="block"),
en&&m(en)),0===St){
if(Lt=i.logo_url,Ft=i.nick_name,d&&(Rt=[]),t=i.elected_comment,t&&t.length){
if(y(t,l,"elected"),d&&(At.list.innerHTML=""),At.list.appendChild(l),m(At.main),
Yt&&0===Gt?(document.getElementById("js_cmt_nofans1").innerHTML="作者已设置关注3天后才可留言",
m(document.getElementById("js_cmt_nofans1"),"block")):Et&&0===i.is_fans?(document.getElementById("js_cmt_nofans1").innerHTML="Follow first to comment",
m(document.getElementById("js_cmt_nofans1"),"block")):wt&&(Qt?(m(At.commentPC),m(At.inputPC)):m(At.addCmtBtn1)),
...
}else a(At.main),Yt&&0===Gt?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注3天后才可留言",
m(document.getElementById("js_cmt_nofans2"),"block")):Et&&0===i.is_fans?(document.getElementById("js_cmt_nofans2_inner").innerHTML="Follow first to comment",
m(document.getElementById("js_cmt_nofans2"),"block")):wt&&(Qt?(m(At.commentPC),m(At.inputPC)):m(At.addCmtBtn2));
n=i.friend_comment,y(n,c,"friend"),n&&0===n.length&&a(en),d&&(At.fdlist.innerHTML=""),
At.fdlist&&At.fdlist.appendChild(c),n&&n.length?(m(At.fdmain),(!Et||Et&&1===i.is_fans)&&(Qt||(a(At.addCmtBtn1),
a(At.addCmtBtn2),wt&&m(At.addCmtBtn3)))):a(At.fdmain);
...
0===i.elected_comment_total_cnt?(St=-1,a(document.getElementById("js_cmt_loading")),
a(document.getElementById("js_cmt_statement")),a(document.getElementById("js_cmt_qa"))):St+Vt>=i.elected_comment_total_cnt?(St=-1,
a(document.getElementById("js_cmt_loading")),m(document.getElementById("js_cmt_statement")),
...
var w=0;
m(At.showAll),a(document.getElementById("js_cmt_statement"));
...
At.listContainer.style.height=w+"px",At.showAllWording.innerText="View %s more comment(s)".replace("%s",t.length-f);
var b=function(){
...
window.addEventListener("resize",b),window.ipados13_font_scale&&(ut.setFontSize(At.showAllWording,window.ipados13_font_scale/100),
ut.onFontScaleChange(b)),ft.setSum(110809,25,1);
}
...
if(!(Pt||-1===St||St>0&&i-o-et.getInnerHeight()>500)){
...
var s=Z.join("/mp/appmsg_comment",{
action:"getcomment",
scene:bt.scene,
appmsgid:window.appmsgid,
idx:window.idx,
...
Pt=!0,a(At.tips),m(At.loading);
try{
zt++,t&&(Dt=[]),zt>1&&!t&&_(bt.moreList,encodeURIComponent(s)),Dt.indexOf(s)>-1&&_(bt.repeatList,encodeURIComponent(s)),
Dt.push(s);
}catch(l){
console.error(l);
}
nn&&console.info("[Comment on Article] Request comment data:",s),st("[Appmsg comment] start get comment data, url:"+s),
it({
url:s,
dataType:"json",
success:function(e){
...
forceRefresh:t,
loadTime:Date.now()-d
}):_(bt.errList,"type:resperr;url:"+encodeURIComponent(s)+";ret="+o),st("[Appmsg comment] get comment success");
},
error:function(){
_(bt.errList,"type:ajaxerr;url:"+encodeURIComponent(s)),st("[Appmsg comment] get comment ajax error");
},
complete:function(){
Pt=!1,a(At.loading),ot.off(window,"scroll",u);
}
});
}
}
...
function C(){
At.list.children.length?At.fdlist.children.length?(wt&&m(At.addCmtBtn3),a(At.addCmtBtn1),
a(At.addCmtBtn2),a(At.addCmtBtn4)):(wt&&m(At.addCmtBtn1),a(At.addCmtBtn2),a(At.addCmtBtn3),
a(At.addCmtBtn4)):At.fdlist.children.length?(wt&&m(At.addCmtBtn3),a(At.addCmtBtn4),
a(At.addCmtBtn1),a(At.addCmtBtn2)):(wt&&m(At.addCmtBtn2),a(At.addCmtBtn3),a(At.addCmtBtn1),
a(At.addCmtBtn4)),Qt&&(a(At.addCmtBtn1),a(At.addCmtBtn2),a(At.addCmtBtn3));
}
function b(e,t){
...
}],n,"mine"),At.mylist.insertBefore(n,At.mylist.firstChild),s(),Qt?(At.input.innerHTML="",
...
if(e=Qt?c(Nt).replace(/<br\/>/g,"").replace(/\n/g,"")||"":c(At.input.value),lt.log("tag2"),
!Y.hasClass(At.submit,"btn_disabled")&&At.submit.disabled!==!0){
if(lt.log("tag3"),e.length<1)return void d("Comment cannot be blank");
if(lt.log("tag4"),e.length>600)return void d("600 characters max");
Qt&&(e=Nt),lt.log("tag5"),Qt?At.submit.disabled=!0:Y.addClass(At.submit,"btn_disabled"),
lt.log("tag6");
...
dataType:"json",
success:function(n){
switch(lt.log("tag8"),Qt||on.hidePannel(),+n.ret){
case 0:
b(n,e);
break;

case-6:
d("You're commenting too frequently. Take a break and try again later.");
break;

case-7:
d("You have not followed this Official Account yet. Unable to comment.");
break;

case-10:
d("600 characters max");
break;

case-15:
d("Comments have been disabled");
break;

default:
It=e,d("System error. Try again later.");
}
0!==Number(n.ret)&&_(bt.addCommentErr,"type:resperr;url:"+encodeURIComponent(t)+";ret="+n.ret);
},
error:function(e){
lt.log("shit;"+e.status+";"+e.statusText),_(bt.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(t));
},
complete:function(){
""!==At.input.value&&Y.removeClass(At.submit,"btn_disabled");
}
});
}
}
...
o&&o.length&&(Qt&&(m(At.myareaPC),m(At.mylist),o=B(o)),y(o,i,"mine"),At.mylist.appendChild(i)),
Ot=2;
}else Ot=0,_(bt.errComment,"type:resperr;url:"+encodeURIComponent(t)+";ret="+n);
},
error:function(){
Ot=0,_(bt.errComment,"type:ajaxerr;url:"+encodeURIComponent(t));
},
complete:function(){
a(e),s();
}
...
function k(e){
Mt=et.getScrollTop(),a(At.article),m(At.mine),At.deletePanel=document.getElementById("js_delete_panel_mobile"),
...
window.__second_open__&&Q.os.ios&&m(At.fakebar),window.scrollTo(0,0),I(),e||lt.later(function(){
At.input.focus();
});
}
function E(){
...
function T(){
return rt.isWechat?Q.os.ipad?!1:rt.isInMiniProgram?!1:rt.isIOS&&rt.gtVersion("7.0.8")?!0:rt.isAndroid&&rt.gtVersion("7.0.8")?!0:et.isNativePage()&&(rt.isIOS||rt.isAndroid)?!0:!1:!1;
}
function x(){
...
function S(){
a(At.mine),m(At.article),At.deletePanel=document.getElementById("js_delete_panel"),
At.deleteConfirm=document.getElementById("js_delete_confirm"),At.deleteCancel=document.getElementById("js_delete_cancel"),
window.scrollTo(0,Mt),At.input.blur(),Y.removeClass(document.body,Jt),Y.removeClass(document.body,Xt),
et.isNativePage()||sn(dn||Wt?"#232323":"#ffffff");
}
function M(e){
var t=Y.hasClass(e,"praised"),n=e.querySelector(".praise_num"),o=parseInt(n.getAttribute("data-num")||0,10),i=n.getAttribute("data-like");
t===("1"===i)&&(t?o--:o++),"en"===window.LANG?n.innerHTML=nt.dealLikeReadShow_en(o):-1===n.innerHTML.indexOf("0K")&&(n.innerHTML=o),
t?(Y.removeClass(e,"praised"),e.dataset.status=0):(Y.addClass(e,"praised"),e.dataset.status=1);
}
function P(e){
var t=e.delegatedTarget||e.srcElement,n=null;
if(Y.hasClass(t,"js_comment_praise")&&(n=t),n){
for(var o=parseInt(n.dataset.status,10),i=0===o?1:0,m=n.dataset.contentId,a=n.dataset.scene,s=document.querySelectorAll('.js_comment_praise[data-content-id="'+m+'"]'),d=0;d<s.length;d++)M(s[d]);
J({
...
function L(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status,10),o=n?0:1,i=t.dataset.contentId,m=t.dataset.replyId,a=t.dataset.scene,s=document.querySelectorAll('.js_reply_praise[data-content-id="'+i+'"]'),d=0;d<s.length;d++)M(s[d]);
it({
...
function H(e,t){
e.parentNode.removeChild(e),Y.addClass(At.deletePanel,"weui-transition_opacity-hide");
for(var n=document.querySelectorAll(".cid"+t),o=0;o<n.length;o++)n[o].parentNode.removeChild(n[o]);
At.list.children.length?At.fdlist.children.length||a(At.fdmain):(a(At.main),a(document.getElementById("js_cmt_statement")),
a(document.getElementById("js_cmt_qa")),At.fdlist.children.length||a(At.fdmain)),
s(),C();
}
function z(e){
...
Y.removeClass(At.deletePanel,"weui-transition_opacity-hide"),ot.on(At.deleteConfirm,"click",function(){
t!==i&&(t=i,it({
url:m,
dataType:"json",
success:function(e){
...
t!==i&&(t=i,Y.addClass(At.deletePanel,"weui-transition_opacity-hide"));
});
}
function D(e){
e&&e.preventDefault(),S(),a(At.fakebar);
}
function A(e,t){
...
IsFans:vt,
CommentPageType:2
},Ct)):(et.isNativePage()||(Y.addClass(document.body,Jt),sn("5"===window.item_show_type||Wt?"#191919":"#ffffff")),
t?(nn&&console.log("FakeHash on comment"),void k()):(e.preventDefault(),window.__second_open__&&Q.os.ios?k():(nn&&console.log("push comment"),
at.push("comment")),void _t.report(19048,_extends({
EventType:1,
IsFans:vt,
CommentPageType:1
},Ct))));
...
function F(){
at.on("comment",function(){
A(null,!0);
}),at.on("article",function(){
...
n.length<1?Y.addClass(At.submit,"btn_disabled"):Y.removeClass(At.submit,"btn_disabled"),
Q.os.ios&&e.data&&an.indexOf(e.data)>-1&&(Ht=!0);
}),ot.on(At.input,"click",function(){
Q.os.ios&&Ht&&(At.input.blur(),At.input.focus(),Ht=!1);
}),ot.on(At.el_alertConfirm,"click",function(){
At.el_alertPanel.style.display="none";
}),Qt&&ot.on(At.input,"click",function(){
a(document.getElementById("js_emotion_panel_pc"));
}),ot.on(At.list,"click",".js_comment_praise",P),ot.on(At.mylist,"click",".js_comment_praise",P),
ot.on(At.fdlist,"click",".js_comment_praise",P),ot.on(At.list,"click",".js_reply_praise",L),
ot.on(At.fdlist,"click",".js_reply_praise",L),ot.on(At.list,"click",".js_del",z),
...
try{
for(var m,a=t[Symbol.iterator]();!(n=(m=a.next()).done);n=!0){
var s=m.value;
Y.hasClass(s,"praised")===!e.is_like&&M(s);
}
}catch(d){
o=!0,i=d;
}finally{
...
e.preventDefault();
}),ot.on(At.submit,"click",v),ot.on(At.submit,"click",function(e){
e.preventDefault();
}),At.goback&&(ot.on(At.goback,"click",D),ot.on(At.goback,"click",D)),window.__second_open__&&Q.os.ios&&!function(){
ot.on(At.input,"click",function(){
a(At.fakebar);
...
a(At.inputPC),m(At.containerPC),N(At.containerPC)&&R(At.containerPC),At.input.focus();
}),ot.bindVisibilityChangeEvt(function(e){
e&&et.getScrollTop()<X.getOffset(At.cmtContainer).offsetTop-et.getInnerHeight()&&j({
forceRefresh:!0,
cb:h
});
}),ot.on(At.showAllWording,"tap",function(e){
e.preventDefault(),a(At.showAll),m(document.getElementById("js_cmt_statement")),
...
m=!0),i){
var a=m?document.createTextNode(i):i;
e.replaceChild(a,o);
...
y.innerText=e,e>600?(w.style.display="",Y.addClass(w,"comment_primary_counter_warn"),
At.submit.disabled=!0):1>e?(w.style.display="none",Y.removeClass(w,"comment_primary_counter_warn"),
At.submit.disabled=!0):(w.style.display="none",Y.removeClass(w,"comment_primary_counter_warn"),
...
var i=n.createContextualFragment(e),m=i.lastChild,a=tt.getSelection();
n.deleteContents(),n.insertNode(i),n.setStartBefore(m),n.setEndAfter(m),a.removeAllRanges(),
a.addRange(n),document.execCommand("Delete",!1,null);
...
Q.os.Mac&&(window.onblur=function(){
...
""===c(o)&&(a(At.containerPC),m(At.inputPC),a(n));
}
p(t,n)||p(t,At.emotionSwitchPC)||"none"===n.style.display||a(n);
},!1),lt("li.js_emotion_item").on("click",r);
}
function q(t){
if(Et=t.only_fans_can_comment,Ft=t.nick_name,vt=t.is_fans,Lt=t.logo_url,Bt=t.comment_count,
Yt=t.only_fans_days_can_comment,Gt=t.is_fans_days,window._has_comment=!0,!Zt||0===Number(xt))return void(window._has_comment=!1);
if($t){
...
var a="";
1*window.item_show_type===10&&(a=document.getElementById("js_text_content").innerHTML.replace(/<(\/?)(?=((a(\s|>))|(\/a))).*?>/g,""));
var s=document.createElement("div");
s.innerHTML=mt.tmpl(dt,{
new_appmsg:window.new_appmsg,
isIos:Q.os.ios,
textPageTitle:a
}),document.body.appendChild(s),Qt?(i("js_cmt_mine"),document.getElementById("js_avatar_pc").src=Lt,
Y.addClass(document.body,"pages_skin_pc")):i("js_cmt_addbtn_pc"),At={
...
},window.__second_open__&&Q.os.ios&&(At.mine.style.marginBottom=getComputedStyle(At.fakebar).height),
!t.notAutoGetComment&&j({
forceRefresh:!0,
cb:h
}),E(),Qt&&I(),on.init(),O(),Qt&&U();
}
function W(){
F();
}
e("biz_common/utils/string/html.js");
var Y=e("biz_common/dom/class.js"),G=e("appmsg/cmt_tpl.html.js"),V=e("biz_common/utils/wxgspeedsdk.js"),K=e("appmsg/comment_report.js"),Q=e("biz_wap/utils/device.js"),J=e("appmsg/retry_ajax.js"),X=e("biz_common/dom/offset.js"),Z=e("biz_common/utils/url/parse.js"),$=e("biz_wap/jsapi/core.js"),et=e("common/utils.js"),tt=e("appmsg/emotion/selection.js"),nt=e("appmsg/i18n.js"),ot=e("biz_common/dom/event.js"),it=e("biz_wap/utils/ajax.js"),mt=e("biz_common/tmpl.js"),at=e("biz_wap/utils/fakehash.js"),st=e("appmsg/log.js"),dt=e("appmsg/my_comment_tpl.html.js"),lt=e("appmsg/emotion/dom.js"),ct=e("pages/utils.js"),rt=e("biz_wap/utils/mmversion.js"),_t=e("common/comm_report.js"),pt=e("biz_wap/utils/position.js"),ut=e("appmsg/set_font_size.js"),gt=e("common/color/background_color.js"),ft=e("biz_wap/utils/jsmonitor_report.js"),wt=!window.isPaySubscribe||window.isPaySubscribe&&window.isPaid,yt={
...
repeatContent:24,
repeatContentID:23
},vt=void 0,Bt=void 0,It=void 0,kt=void 0,Et=void 0,Tt=void 0,xt=window.comment_id,St=0,Mt=void 0,Pt=!1,Lt="",Ht=!1,zt=0,Dt=[],At={},Rt=[],Nt="",Ft="Me",Ot=0,Ut={},qt=Date.now(),Wt=!1,Yt=void 0,Gt=void 0,Vt=100,Kt=location.href,Qt=Q.os.pc,Jt="comment_editing",Xt="my_comment_empty_data",Zt=navigator.userAgent.indexOf("MicroMessenger")>-1,$t=document.getElementById("js_cmt_area"),en=document.getElementById("js_friend_cmt_area"),tn=document.getElementById("js_cmt_container"),nn=Kt.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1,on=e(Qt?"appmsg/emotion/emotion_pc.js":"appmsg/emotion/emotion.js"),mn="http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0",an=["“”","‘’","（）","《》","〈〉","「」","『』","〔〕","【】","［］","[]","｛｝","{}","()","<>"],sn=function(e){
...
if(!et.isNativePage()){
var ln=["#ffffff"];
ln.push(Y.hasClass(document.body,Jt)?"#191919":"#232323"),gt.set({
nav:ln,
top:ln
});
}
return window.pageCommentReportData&&window.pageCommentReportData.idkey&&(nn&&console.log("init reportData"),
bt=window.pageCommentReportData),"undefined"!=typeof window.comment_id?xt=window.comment_id:window.cgiData&&"undefined"!=typeof window.cgiData.comment_id&&(xt=window.cgiData.comment_id),
Zt||($t&&($t.style.display="none"),en&&(en.style.display="none"),xt=0),nn&&console.info("[Comment on Article] Comment ID:",xt),
W(),{
initComment:q,
getCommentData:j,
renderComment:h
...
t&&t>0&&(el_friend_like.innerHTML="Being viewed by %s friend(s).".replace("%s",t),
document.getElementById("js_friend_like_word").innerText='Go to "Discover" > "Top Stories" to view',
...
"100k+"!==e&&(el_likeNum.innerHTML=dealLikeReadShow(realLikeNum));
...
realLikeNum-=1,realLikeNum>=0&&"100k+"!==i&&(el_likeNum.innerHTML=dealLikeReadShow(realLikeNum)),
...
var i="";
if(parseInt(e)>1e5)i="100k+";else if(parseInt(e)>1e4&&parseInt(e)<=1e5){
var t=""+parseInt(e)/1e4,o=t.indexOf(".");
i=-1===o?t+"0K":t.substr(0,o)+"."+t.charAt(o+1)+"0K";
...
var i=e||{};
if(i.show){
var t=i.readAreaDom,o=i.readNumDom;
...
parseInt(s,10)>r&&window.item_show_type&&"5"===window.item_show_type&&("en"!=LANG&&(document.getElementById("readTxt").innerText="Play"),
n=i.videouv||0),1===appmsg_like_type?(parseInt(n)>1e5?n="100000+":"",o&&(o.innerHTML=n)):2===appmsg_like_type&&(o.innerHTML=dealLikeReadShow(n),
""===o.innerHTML&&(o.innerHTML="0"));
}
}
...
var a=function(){
if(o&&o.base_resp&&1*o.base_resp.ret===0)if(O=o.article_size||0,0===o.list.length)P?r(0!==t):f.addClass(B,"hide");else{
...
reason:W,
begin:t
}),d=i(a),l=0;l<d.length;l++)k.appendChild(d[l].cloneNode(!0));
P?(o.list.length<n||o.article_size<=t+n)&&r(0!==t):o.article_size===n?(Q=!1,f.addClass(B,"hide")):o.article_size>n&&(Q=!0,
f.removeClass(B,"hide"),g.on(B,"click",s)),window.ipados13_font_scale&&x(k,window.ipados13_font_scale/100);
}
};
...
O>1&&1*B.getAttribute("data-hasreport")!==1&&B.clientHeight+B.offsetTop>=i+B.clientHeight/2&&B.clientHeight+B.offsetTop<=i+B.clientHeight/2+y.getInnerHeight()&&!function(e){
...
function c(){
g.on(k,"click",".js_related_item",function(e){
...
}),g.on(k,"touchstart",".js_related_item",function(e){
e.stopPropagation();
var t=e.delegatedTarget;
f.addClass(t,"card_custom_active");
},!1),g.on(k,"touchend",".js_related_item",function(e){
e.stopPropagation();
var t=e.delegatedTarget;
...
1===k.children.length&&(P&&!R?(S.style.display="none",C.style.display=""):!P&&Q?(k.style.display="none",
B.style.display="none",T.style.display="",g.off(B,"click",s),g.on(T,"click",s)):E.style.display="none"),
e.parentNode.removeChild(e);
}
});
}
e("biz_common/utils/string/html.js");
var m=e("biz_common/tmpl.js"),p=e("biz_wap/utils/ajax.js"),u=e("biz_wap/jsapi/core.js"),_=e("appmsg/related_article_tpl.html.js"),w=e("biz_wap/utils/openUrl.js"),g=e("biz_common/dom/event.js"),y=e("common/utils.js"),f=e("biz_common/dom/class.js"),b=e("biz_common/utils/url/parse.js"),j=e("appmsg/i18n.js"),h=e("common/comm_report.js"),z=e("appmsg/related_article_feedback.js"),I=e("biz_wap/utils/mmversion.js"),v=e("biz_wap/utils/device.js"),x=e("appmsg/set_font_size.js").setFontSize,A=e("biz_wap/utils/jsmonitor_report.js"),E=document.getElementById("js_related_area"),k=document.getElementById("js_related"),B=document.getElementById("js_related_load_more"),T=document.getElementById("js_more_article"),S=document.getElementById("js_related_load_more_pc"),H=document.getElementById("js_related_loading_pc"),C=document.getElementById("js_more_article_pc"),M=document.getElementById("js_related_all_pc"),P=v.os.ipad||!I.isIOS&&!I.isAndroid,O=0,Q=!1,U={
Bizuin_from:window.biz,
Msgid_from:window.parseInt(window.mid,10)||0,
Itemidx_from:window.parseInt(window.idx,10)||0,
Scene:window.parseInt(window.source,10)||0,
...
function s(e){
function s(e){
for(var s=window.location.href,t=s.indexOf("?"),i=s.substr(t+1),_=i.split("&"),n=0;n<_.length;n++){
var a=_[n].split("=");
...
var t=e("appmsg/log.js"),i=e("biz_wap/utils/ajax.js"),_=e("rt/appmsg/getappmsgext.rt.js"),n=e("biz_common/utils/wxgspeedsdk.js"),a=void 0;
return{
getData:s
};
